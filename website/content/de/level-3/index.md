...
Sie sehen jetzt eine hohe Zentralisierung mit klaren und verstandenen Verantwortlichkeiten. Dabei kann es jedoch zu einem Geschwindigkeitsrückgang und zu Engpässen kommen. Die Prozesse könnten sich hinziehen.

### Sicherheit

Ihre Risikotoleranz wird sich darauf auswirken, in welchem Umfang Sie auf Cloud-native-Security Trainings setzen um Ihre Mitarbeiter aktiv zu schulen.

### Agilität der Entwickler

Ihre Mitarbeiter haben Continuous Delivery für alle Umgebungen implementiert, auch für komplexe Releases und mit integrierten Compliance-Tests. Das Operations-Team ist jetzt in cross-funktionale Teams eingebunden, auch wenn jeder einzelne nicht unbedingt alle Funktionen ausführen können muss.
...
Ihre Codequalität, gemessen mit automatisierten Werkzeugen, verbessert sich und Sie sehen häufig erfolgreich abgeschlossene CI-Builds und Tests.

### Sicherheit

Implementieren Sie eine automatische und kontinuierliche Überprüfung um Fehlkonfigurationen oder Sicherheitsprobleme zu erkennen.

### Audit und Logs

Beginnen Sie mit der Prüfung und Umsetzung erster Benachrichtigungen. Filtern Sie Rauschen heraus.
...
- Monitoring von Sicherheitsangriffen. Business-Übersetzung: weniger Risiko von gestohlene Daten.
